...
if __name__=="__main__":
    ...
    while 1:
        ...
        choice = input()
        if choice == '1':
            Sun = _system.Planet("Sun",1.9885e30,[-1.236499415040757E+06,6.025375268375650E+05 ],[-7.542015186487071E-03,-1.403959979998188E-02],[0, 0])
            Earth = _system.Planet("Earth",5.97219e24, [1.411307100326878E+08,4.576889747036675E+07], [-9.511592529337820E+00,2.827120433963588E+01], [0,0])
            ...
            Jupiter = _system.Planet("Jupiter", 1.89818722e27, [6.579320580151826E+08, -3.563111248294134E+08], [6.063642398054531E+00, 1.210338130121029E+01], [0,0])
